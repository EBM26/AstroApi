signs = Sign.create([

    {
       ...
       color: "red", 
       stone: "ruby",
       life_goal: "Actualize self-expression", 
       metal: "iron", 
...

    {
     ...
     
     {
       ...
       color: "yellow",
       stone: "topaz",
       life_goal: "Explore the world and all it's ideas",
       metal: "mercury",
     ...
     
     {
       ...
       color: "silver",
       stone: "pearl",
       life_goal: "Achieve emotional security",
       metal: "silver",
...

     {
       ...
       color: "black",
       stone: "jasper",
       life_goal: "Achieve personal empowerment",
       metal: "iron",
...

     {
       ...
       color: "blue",
       stone: "amethyst",
       life_goal: "Know the ultimate truth",
       metal: "tin",
...

     {
       ...
       color: "sky blue",
       stone: "sapphire",
       life_goal: "Promote human equality",
       metal: "cast",
